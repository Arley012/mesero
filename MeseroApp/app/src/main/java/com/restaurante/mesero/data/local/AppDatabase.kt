    ...
    companion object {
        ...
        private fun build(context: Context): AppDatabase {
            ...
            val database = Room.databaseBuilder(
                ...
                .addMigrations(MIGRACION_1_A_2, MIGRACION_2_A_3)
        ...
        /**
         * v2 -> v3: agrega el control de turno del mesero (hora de inicio) y la
         * lista personalizable de "detalles rápidos" de Estadísticas, sin perder
         * la configuración ya guardada.
         */
        private val MIGRACION_2_A_3 = object : Migration(2, 3) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE configuracion ADD COLUMN turnoInicio INTEGER")
                db.execSQL(
                    "ALTER TABLE configuracion ADD COLUMN detallesRapidos TEXT NOT NULL " +
                        "DEFAULT 'VENTAS_TOTALES,PEDIDOS_HOY,MESAS_ATENDIDAS,PROMEDIO_MESA'"
                )
            }
        }
    }
